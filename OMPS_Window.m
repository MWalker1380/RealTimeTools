...
function param = getSingleParam(granule, paramInd, parByteSize, parBits, numType)
    ...
    % size minus the bits in each byte i.e. for a d11 paBits will be 3
    ...
    if parBits == 0 % if the param is in multiples of 8 bits
        ...
        paramIndBit = round(8*mod(paramInd, 1)) + 1; % get the bits where  it start. May be 0. add 1 to make it 1-indexed for matlab
...
function playBack(handles)
    ...
    if ~(isfield(handles, 'numType') && isfield(handles, 'files')), return; end
        ...
        for granNum=0:maxGran
          granule = getGranule(handles.rdrType, granNum, file);
            ...
            while ~apidFound
                ...
                if ind==numAP
                    error(['APID ' num2str(handles.APID) ' not present in packet']); 
                end
...
function updatePannel(handles)
    switch get(handles.popupmenu2, 'value')
        case 1
            ...
            handles.numType = 's16';
            handles.indInPkt = 802;
            handles.APID = uint32(544);
            handles.plot_title = 'Voltage - Motor/Resolver Electronics +5V';                                           
        ...
        case 2
            ...
            handles.rdrType = 'OMPS-TELEMETRY-RDR_All';
            handles.numType = 's16';
            handles.indInPkt = 804;
            handles.APID = uint32(544);
            handles.plot_title = 'Voltage - Resolver Electronics +12V';                                           
        ...
        case 3
            ...
            handles.rdrType = 'OMPS-TELEMETRY-RDR_All';
            handles.numType = 'U16';
            handles.indInPkt = 956;
            handles.APID = uint32(544);
            handles.plot_title = 'Limb Diffuser Motor Position';                                           
        ...
        case 4
            ...
            handles.rdrType = 'OMPS-TELEMETRY-RDR_All';
            handles.numType = 'U16';
            handles.indInPkt = 950;
            handles.APID = uint32(544);
            handles.plot_title = 'Limb Diffuser Move Destination';                                   
        ...
        case 5
            ...
            handles.rdrType = 'OMPS-TELEMETRY-RDR_All';
            handles.numType = 'U16';
            handles.indInPkt = 938;
            handles.APID = uint32(544);
            handles.plot_title = 'Nadir Diffuser Motor Position';                                
        
        case 6
            
            handles.rdrType = 'OMPS-TELEMETRY-RDR_All';
            handles.numType = 'u16';
            handles.indInPkt = 928;
            handles.APID = uint32(544);
            handles.plot_title = 'Nadir Diffuser Move Destination';            
            
        case 7
            
            handles.rdrType = 'OMPS-TELEMETRY-RDR_All';
            handles.numType = 'd8';
            handles.indInPkt = 193;
            handles.APID = uint32(544);
            handles.plot_title = 'Nadir CCD Power Status';
        ...
        case 8
            ...
            handles.rdrType = 'OMPS-TELEMETRY-RDR_All';
            handles.numType = 'd8';
            handles.indInPkt = 300;
            handles.APID = uint32(544);
            handles.plot_title = 'Limb CCD Power Status';
            
        case 9
            
            handles.rdrType = 'OMPS-TELEMETRY-RDR_All';
            handles.numType = 's16';
            handles.indInPkt = 624;
            handles.APID = uint32(544);
            handles.plot_title = 'Current - CPE +5V Input';
            

    end
    % update guifcn. his needs two inputs, so mae the first anything random
